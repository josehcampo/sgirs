  ...
  try {
    ...
    if (error.code == '23505') {
      return res.status(409).json({
        message: 'Ya existe una respuesta del usuario',
      });
    }
    next(error);
  }
